...
$app->get('/produtos', function(){
    ...
    foreach ($data as &$produto) {
        ...
        $produto['preco_promorcional'] = number_format($produto['preco_promorcional'], 0, ",", ".");
...
$app->get('/produtos-mais-buscados', function(){
    ...
    foreach ($data as &$produto) {
        $preco = $produto['preco'];
        $produto['preco_promorcional'] = number_format($produto['preco_promorcional'], 2, ",", ".");
        $produto['parcelas'] = 10;
        $produto['parcela'] = number_format($preco/$produto['parcelas'], 2, ",", ".");
        $produto['nome_prod_longo'] = utf8_decode($produto['nome_prod_longo']);
    }
...
$app->get('/calcular-frete-:cep', function($cep){
    ...
    require_once("inc/Correios/Frete.php");
