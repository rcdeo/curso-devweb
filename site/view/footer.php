<footer>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 text-center hidden-xs">
                    <img class="logotipo" src="images/orlando-logo.png" alt="Logotipo">
                </div>
                    ...
                    <div class="row row-cols">
                        ...
                        <div class="col-md-4 col-get-in-touch">
                            ...
                            <ul class="list-unstyled list-socials">
                                ...
                                <li class="page-up"><a href="#" id="page-up"><i class="fa fa-chevron-up"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="row row-cinza-escuro">
        ...
        <div class="container copyright-mobile">
            ...
            <p class="pull-right text-roxo">Create by @rcdeo in Udemy</p>
        </div>
...
<script src="js/orlando.js"></script>
